...
func TestAppendToFile(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:           "convert @tag after whitespace",
			initialContent: "",
			appendContent:  "hello @work",
			indent:         0,
			expectedResult: "- hello #work\n",
			expectError:    false,
		},
		{
			name:           "convert multiple @tags",
			initialContent: "",
			appendContent:  "@one and @two",
			indent:         0,
			expectedResult: "- #one and #two\n",
			expectError:    false,
		},
		{
			name:           "convert @tag after newline",
			initialContent: "",
			appendContent:  "line1\n@work",
			indent:         0,
		...
		{
			name:           "do not convert email",
			initialContent: "",
			appendContent:  "reach me at foo@bar.com",
			indent:         0,
			expectedResult: "- reach me at foo@bar.com\n",
			expectError:    false,
		},
		{
			name:           "do not convert without leading whitespace",
			initialContent: "",
			appendContent:  "foo@bar",
			indent:         0,
